                ...
                <div class="row mb-2">
                    ...
                    <div class="col-6 p-0">
                        <div class="button-add-new">
                            <a href="${requestScope['javax.servlet.forward.request_uri']}add">
                        ...
                        <div class="row p-0">
                            <div class="col-12 p-0">
                                <div class="alert alert-success" role="alert">
                                    <div class="font-weight-bold">A recept törlése sikeres.</div>
                                </div>
                            </div>
                        </div>
                    </c:when>
                        ...
                        <div class="row p-0">
                            <div class="col-12 p-0">
                                <div class="alert alert-danger" role="alert">
                                    <div class="font-weight-bold">A recept nem törölhető!</div>
                                </div>
                            </div>
                        </div>
                    </c:when>
                ...
                <div class="container bg-white rounded shadow-sm p-3">
                    <table class="table table-hover table-sm">
                        ...
                        <tr>
                            ...
                            href="${requestScope['javax.servlet.forward.request_uri']}edit/<c:out value="${recipe.getId()}"/>"><c:out value="${recipe.getName()}"/></a></td>
                            <td>${recipe.getMaterialItems()} db</td>
                            <td class="fix150">${recipe.getCreatedAt()}</td>
                            <td>
                                <div class="operations">
                                    <a href="${requestScope['javax.servlet.forward.request_uri']}edit/1">
                                    ...
                                    <button type="button" class="btn btn-operations-small btn-danger ml-1 button-delete" title="Törlés"
                                            data-href="${requestScope['javax.servlet.forward.request_uri']}delete/1">
